...
function useBottomMaskReveal(ref, options = {}) {
  ...
  useGSAP(() => {
    ...
    originalChars.forEach((char) => {
      ...
      gsap.set(inner, { y: randY, rotation: randRot, scale: randScl, opacity: 0, transformOrigin: 'center center' })
      inners.push(inner)
    })
...
function Hero() {
  ...
  return (
    <section ref={containerRef} style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'120px 48px 80px', position:'relative', overflow:'hidden' }}>
      ...
      <h1 ref={headlineRef} className="h1" style={{ maxWidth:'860px', marginBottom:'24px', overflow:'hidden' }}>Make Your Site Come To Life.</h1>
      <p ref={subRef} style={{ fontSize:'17px', color:'var(--text-muted)', maxWidth:'500px', lineHeight:'1.65', marginBottom:'40px' }}>A curated library of production-ready GSAP animations. Preview, customize values, and copy the code instantly.</p>
      <div ref={ctaRef} style={{ display:'flex', gap:'12px', alignItems:'center', marginBottom:'72px' }}>
        <a href="#collection" style={{ fontSize:'14px', fontWeight:'500', color:'#fff', background:'var(--accent)', padding:'12px 24px', borderRadius:'8px', textDecoration:'none', transition:'background 0.2s, transform 0.2s' }}
          ...
          onMouseLeave={(e)=>{e.currentTarget.style.background='var(--accent)';e.currentTarget.style.transform='translateY(0)'}}>Explore Collection →</a>
        <a href="https://gsap.com" target="_blank" rel="noreferrer" style={{ fontSize:'14px', color:'var(--text-muted)', padding:'12px 24px', borderRadius:'8px', textDecoration:'none', border:'1px solid var(--border)', transition:'all 0.2s' }}
          ...
          onMouseLeave={(e)=>{e.currentTarget.style.color='var(--text-muted)';e.currentTarget.style.borderColor='var(--border)'}}>GSAP Docs ↗</a>
      </div>
...
function VideoSection() {
  ...
  return (
    <div ref={wrapperRef} style={{ marginTop:'-10vh', position:'relative', zIndex:1 }}>
      <div ref={videoRef} style={{ width:'100%', aspectRatio:'16/9', background:'var(--surface)', overflow:'hidden', position:'relative', cursor:'none', transformOrigin:'center top' }}>
...
function Introduction() {
  ...
  useBottomMaskReveal(titleRef, { yRange:80, rotationRange:20, stagger:0.035, duration:0.75, start:'top 82%' })
  ...
  return (
    <section ref={sectionRef} style={{ padding:'120px 48px', maxWidth:'1200px', margin:'0 auto', borderTop:'1px solid var(--border)' }}>
      <div style={{ display:'flex', flexDirection:'column', alignItems:'center', marginBottom:'96px' }}>
        ...
        <h2 ref={titleRef} className="h2-lg" style={{ textAlign:'center', maxWidth:'560px', overflow:'hidden' }}>Discover, Learn, and Ship Animations</h2>
      </div>
...
function Marquee() {
  ...
  return (
    <section style={{ padding:'40px 0', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)', overflow:'hidden', background:'var(--bg)' }}>
      <div className="marquee-track" ref={trackRef} style={{ display:'flex', alignItems:'center', willChange:'transform' }}>
        {items.map((word,i)=>(
          <span key={i} style={{ display:'inline-flex', alignItems:'center', flexShrink:0 }}>
            <span style={{ fontSize:'13px', fontWeight:'500', letterSpacing:'0.08em', textTransform:'uppercase', color:'var(--text-subtle)', whiteSpace:'nowrap', padding:'0 20px' }}>{word}</span>
...
function CollectionCards() {
  ...
  const titleRef = useRef(null)
  useBottomMaskReveal(titleRef, { yRange:70, rotationRange:18, stagger:0.03, start:'top 82%' })
  ...
  return (
    <section id="collection" ref={ref} style={{ padding:'80px 48px', maxWidth:'1200px', margin:'0 auto' }}>
      <div style={{ marginBottom:'48px' }}>
        ...
        <h2 ref={titleRef} className="h2" style={{ marginBottom:'8px', overflow:'hidden' }}>Animation Categories</h2>
...
function Works() {
  ...
  useBottomMaskReveal(titleRef,{yRange:70,rotationRange:18,stagger:0.03,start:'top 84%'})
  ...
  return (
    <section ref={ref} style={{ padding:'80px 0', borderTop:'1px solid var(--border)', overflow:'hidden' }}>
      <div className="works-header" style={{ padding:'0 48px', maxWidth:'1200px', margin:'0 auto 48px' }}>
        <SectionLabel>Built With AnimVault</SectionLabel>
        <div style={{ display:'flex', alignItems:'flex-end', justifyContent:'space-between', gap:'16px', flexWrap:'wrap' }}>
          <h2 ref={titleRef} className="h2" style={{ overflow:'hidden' }}>Works & Projects</h2>
          <p style={{ fontSize:'13px', color:'var(--text-subtle)', marginBottom:'4px' }}>Real sites built using AnimVault animations</p>
        </div>
      </div>
      <div>
        ...
        <div style={{ display:'flex', justifyContent:'center', alignItems:'center', gap:'12px', padding:'0 48px', marginTop:'8px' }}>
          ...
          <div className="works-pagination" style={{ display:'flex', gap:'4px', alignItems:'center' }} />
...
function CardGridSection({ sectionId, sectionNum, label, titleText, subtitleText, filters, initialShow, items, searchPlaceholder }) {
  ...
  return (
    <section id={sectionId} ref={ref} style={{ padding:'80px 48px', maxWidth:'1200px', margin:'0 auto', borderTop:'1px solid var(--border)' }}>
...
function CTA() {
  ...
  useBottomMaskReveal(titleRef,{yRange:80,rotationRange:20,stagger:0.025,start:'top 82%'})
  useGSAP(()=>{
  ...
  return (
    <section ref={ref} style={{ padding:'128px 48px', borderTop:'1px solid var(--border)', display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', position:'relative', overflow:'hidden' }}>
      ...
      <h2 ref={titleRef} className="h2-cta" style={{ maxWidth:'720px', overflow:'hidden', marginBottom:'24px' }}>Bring Your Site To Life Today.</h2>
      <p ref={subRef} style={{ fontSize:'17px', color:'var(--text-muted)', maxWidth:'440px', lineHeight:'1.7', marginBottom:'40px' }}>Copy production-ready GSAP animations in seconds. No signup, no limits — completely free.</p>
      <div ref={btnRef} style={{ display:'flex', gap:'12px' }}>
        <a href="/heading-reveal" style={{ fontSize:'14px', fontWeight:'600', color:'#fff', background:'var(--accent)', padding:'14px 28px', borderRadius:'8px', textDecoration:'none', transition:'background 0.2s, transform 0.2s' }}
    ...
    <>
      ...
      <main style={{ overflowX:'hidden' }}>
        ...
        <CardGridSection
          ...
          titleText="Sites Worth Studying"
          subtitleText="Stunning websites rich with animation — from GSAP to WebGL to refined micro-interactions."
        ...
        <CardGridSection
          ...
          titleText="Learn GSAP"
          subtitleText="Tutorials, news, and deep-dives on GSAP animation techniques."
